---
updated_at: 2025-11-15T18:39:24.258+05:30
edited_seconds: 30
---
...
- **Newton Forward Difference:**
    ...
    $$
    P_n(x) = y_0 + u \Delta y_0 + \frac{u(u-1)}{2!} \Delta^2 y_0 + \cdots
    $$
...
- **Taylor Series Method:**
    ...
    $$
    y_{n+1} = y_n + h y'_n + \frac{h^2}{2!} y''_n + \frac{h^3}{3!} y'''_n + \cdots
    $$
...
- **Bender-Schmidt Explicit Formula:**
    ...
    $$
    u_{i,j+1} = \frac{k}{2h^2} ( u_{i+1,j} - 2 u_{i,j} + u_{i-1,j} ) + u_{i,j}
    $$
    
- **Crank-Nicholson Scheme:**
    
    $$
    \frac{u_i^{j+1} - u_i^j}{k} = \frac{1}{2h^2} ( u_{i+1}^j - 2 u_i^j + u_{i-1}^j + u_{i+1}^{j+1} - 2 u_i^{j+1} + u_{i-1}^{j+1} )
    $$
